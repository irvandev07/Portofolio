$('.trigger').click(function () {
  ...
  $('.about').click(function () {
    ...
    $('.slider_note').addClass('dnone');
    $('.work').removeClass('active');
    $('.about').addClass('active');
    $('.portfolio_home__work').addClass('dnone');
    $('.portfolio_home__slider').addClass('dnone');
    $('.portfolio_about').removeClass('dnone');
  });

  $('.work').click(function () {
    // window.location.href = "./about.html"
    $('.slider_note').removeClass('dnone');
    $('.about').removeClass('active');
    $('.work').addClass('active');
    $('.portfolio_home__work').removeClass('dnone');
    $('.portfolio_home__slider').removeClass('dnone');
    $('.portfolio_about').addClass('dnone');
  });
